...
namespace init_heights {
  ...
  constexpr float ALLIANCE = 1;
  constexpr float INTAKE = 0;
}

inline float get_height_at_level(const float level, const float init_height, const float height_increment = 25) {
